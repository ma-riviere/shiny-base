...
// dataset-specific). The attributes mirror the Shiny.setInputValue() call:
// sets the input named by `data-shiny-input` to `data-shiny-value`;
// `data-shiny-priority="event"` marks a repeatable action (priority: 'event'),
